        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <h1 className="ml-2 text-2xl font-bold text-gray-900 dark:text-white">Testify</h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Strongest Category</span>
                        <Badge variant="success">Frontend (92%)</Badge>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Improvement Area</span>
                        <Badge variant="outline">Database (78%)</Badge>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Recommended Next</span>
                        <Button variant="ghost" size="sm" asChild>
                          <Link href="/test/4">SQL Queries</Link>
                        </Button>
                      </div>
                      <div className="pt-2">
                        ...
                        <div className="text-right">
                          <div className="flex items-center space-x-6">
                            ...
                            <div className="flex space-x-2">
                              ...
                              <Button size="sm" variant={test.reminder ? "default" : "outline"}>
                ...
                <Card>
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-gray-500 mb-4">
                      Check back later for scheduled tests or browse available tests.
                    </p>
